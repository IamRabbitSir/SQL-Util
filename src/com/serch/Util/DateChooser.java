...
public class DateChooser extends JPanel {
	...
	public DateChooser(Date date, String format) {
		...
		day = select.get(Calendar.DATE);
		initPanel();
		initLabel();
		System.out.println("原来的的日期"+sdf.format(select.getTime()));
		System.out.println("month月份："+month);
		System.out.println("year月份："+year);
		System.out.println("day月份："+day);
	}
